...
from .views import AddressViewSet, BankViewSet, CompanyViewSet, DownloadPurchaseInvoice, DownloadSaleInvoice, PartyBankViewSet, PartyViewSet, PaymentViewSet, ProductViewSet, PurchaseView, ReceiptViewSet, SaleItemView, SaleView, UserViewSet, PurchaseItemView
...
urlpatterns.append(path('downloadSaleRec/<int:id>/', DownloadSaleInvoice.as_view(), name="downloadSaleItem"),)
urlpatterns.append(path('downloadPurchaseRec/<int:id>/', DownloadPurchaseInvoice.as_view(), name="downloadPurchaseItem"),)
